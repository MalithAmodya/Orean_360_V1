...
router.get("/pages/:pageId/posts", authMiddleware as any, getMetaPagePosts as any);

// Instagram
router.get("/instagram/account", authMiddleware as any, getInstagramAccount as any);
